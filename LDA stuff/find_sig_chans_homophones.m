...
is_sig_ttest = ttest2(ecog_c1, ecog_c2, 'Dim',3, 'Alpha', p_thresh);
is_sig_ttest(ERPs.BadChans) = false;

stat_tstat = (mean(ecog_c1,3) - mean(ecog_c2,3))./sqrt(var(ecog_c1,[],3)/size(ecog_c1,3) + var(ecog_c2,[],3)/size(ecog_c2,3));
