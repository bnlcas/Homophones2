function [] = create_channel_spectrogram_erps_vargrid(ERPs, data_dir, subj, varargin);
...
%n_chans = 256;
%% Get number of channels (Assumes 1 block is like all the others...)
data_dir_1 = [data_dir filesep subj '_' ERPs.data_block{1} filesep 'HilbAA_4to200_40band'];
n_chans = length(dir([data_dir_1 '/*.htk']));
